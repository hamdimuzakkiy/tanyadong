...
<html lang="en">
  <head>
    ...
    <!--external css-->
    <link href="<?php print base_url(); ?>assets/bower/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
                <ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?php print base_url(); ?>/login/logout">Logout</a></li>
                </ul>
            </div>
        </header>
      <!--header end-->
